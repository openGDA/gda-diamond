...
package uk.ac.gda.rcp.views.dashboard.actions;
...
import uk.ac.gda.rcp.views.dashboard.SimpleScannableObject;

/**
 * Adds a scannable to the Dashboard
 */
public class AddScannableHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		dashboard.addScannableObject(new SimpleScannableObject());
