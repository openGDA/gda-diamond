...
class CalibratedID(gda.device.scannable.PseudoDevice):
	...
	def __init__(self, name, id):
		...
		#                            E1, E2: Energy range
		#                              n,    E1  ,   E2 ,    a   ,   b   ,   c
		harmonics.append(Harmonic( 3,  3.70,  5.8962, -0.0154, 1.6875,  0.2278) )
		harmonics.append(Harmonic( 5,  5.8962,  8.29, -0.0110, 1.0901, -0.0450) )
		harmonics.append(Harmonic( 7,  8.29, 10.65, -0.0115, 0.8957, -0.6364) )
		harmonics.append(Harmonic( 9, 10.65, 13.00, -0.0075, 0.7111, -0.7234) )
		harmonics.append(Harmonic(11, 13.00, 15.34, -0.0058, 0.6035, -0.8664) )
		harmonics.append(Harmonic(13, 15.34, 17.67, -0.0043, 0.5170, -0.9191) )
		harmonics.append(Harmonic(15, 17.67, 23.11, -0.0032, 0.4478, -0.9143) )
