...
class RelativePositionConverter(IQuantityConverter) :
    ...
    def setReferenceScannable(self, refScannable) :
        ...
        self.units = "eV" # refScannable.getUserUnits()
...
converterRelativeToBragg.setReferenceScannable(energy)
...
print("Creating energy transfer scannable : XESEnergyTransfer")

XESEnergyTransfer = createEnergyTransferScannable(XESEnergyJohann, "XESEnergyTransfer");
