...
class I18SESOLookupExafsScanClass(ScriptBase):
    def __init__(self,detectorList=None):
        ...
        self.SESOSleepTime=2.0
        self.noOfPoints=0
        self.scanList=[]
        self.datafilename="/dls/i18/tmp/lookuptables/Cu_SESO_EXAFS.txt"
   ...
   #==================================================
    ...
    #==================================================
    def writeSummary(self,position,x,y):
        fid = open(self.datafilename,'a')
        print >>fid,position,x,y
        fid.close()
