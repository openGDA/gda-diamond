    ...
    def stepmapscan(self,xstart,xend,xstep,ystart,yend,ystep,collectionTime):
        ...
        try:
            ...
            for i in range(ny):
                ...
                for j in range(nx):
                    ...
                    try:
                        ...
                        if(j >= 1):
                           ...
                           self.getDetectorDataPoint(i, (j - 1), ycurrent, xcurrent - xstep, collectionTime, self.mcafiles[j - 1])
                ...
                self.getDetectorDataPoint(i, self.xindex, ycurrent, xcurrent - xstep, collectionTime, self.mcafiles[self.xindex])
