...
class I18ExafsScanClass(ScriptBase):
    def __init__(self,detectorList=None):
        ...
        self.mcaList=[]
        self.scalarList=[]
        self.interrupted=java.lang.Boolean(0)
        self.paused=java.lang.Boolean(0)
    ...
    def anglescan(self,start,end,step,collectionTime):
        ...
        mysleeptime=collectionTime/1000.0
       # self.timeList=[]
    ...
    def kscan(self,start,end,step,kStartTime,kEndTime,kWeighting, edgeEnergy, twoD):
        ...
        for i in range(npoints):
          ...
          #  starttime=time.time()
            ...
            mysleeptime=int(100.0*(secTime*1.0/1000.0))/100.0
    ...
    def writeDetectorFileAtPoint(self,point):
        ...
        try:
            ...
            if(os.path.exists(scalername)):
                ...
                self.fileArchiveCounter += 1
            print "file counter is " + str(self.fileArchiveCounter)
    ...
    #==================================================
    #
    # Checks to see if an angle scan has been pausedrange(9))
            for i in range(9):
                for j in range(3):
                    scalarData[j][i]=0                    
            return scalarData
...
#==============================================================
    ...
    def switchToTestMode(on):
        global error
        error = on
    switchToTestMode = staticmethod(switchToTestMode)
