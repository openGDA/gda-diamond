...
class I18VortexStepMapClass(ScriptBase):
        ...
        try:
            ...
            for i in range(ny):
                ...
                for j in range(nx):
                    ...
                    self.writeSummary(xcurrent,ycurrent,j,i,collectionTime,vortexdata,vortexSpectrum)
                    self.checkForInterrupt()
    ...
    def writeSummary(self,currentx,currenty,xindex,yindex,collectionTime,vortexdata,vortexSpectrum):
        ##spectrum file
        ...
        ionChambers=counterTimer01.readFrame(xindex+1)
        ...
        fid.close()
        print str(currentx),str(currenty),str(collectionTime),str(ionChambers[0]),str(ionChambers[1]),str(ionChambers[2]),filename
        # SDP Stuff
