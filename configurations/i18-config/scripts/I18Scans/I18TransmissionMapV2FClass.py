...
class I18TransmissionMapClass(ScriptBase):
        ...
        try:
            ...
            for i in range(ny):
                ...
                for j in range(nx):
                    ...
                    self.checkForInterrupt()
                    ionChamberData=self.ionchambers.getPosition()
                    print xcurrent,ycurrent,collectionTime,ionChamberData[0],ionChamberData[1],ionChamberData[2]
                    # update the motor position
                    self.writeSummary(xcurrent,ycurrent,ionChamberData,collectionTime)
    ...
    def writeSummary(self,currentx,currenty,ionChambers,collectionTime):
        ...
        print >>fid,str(currentx),str(currenty),str(collectionTime),str(ionChambers[0]),str(ionChambers[1]),str(ionChambers[2])
        fid.close()
        # SDP Stuff
        ...
        sdp = ScanDataPoint()
        sdp.setUniqueName("Microfocus TransScan")
