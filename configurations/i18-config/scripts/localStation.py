...
non_raster_map = Map(xspressConfig, vortexConfig, D7A, D7B, counterTimer01, rcpController, sc_MicroFocusSampleX, sc_MicroFocusSampleY, ExafsScriptObserver,outputPreparer)
