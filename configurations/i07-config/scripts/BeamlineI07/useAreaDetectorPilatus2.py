...
pil2 = ADPilatusPseudoDeviceClass("pil2", "Pilatus 2", "pilatus2");
pil2.setAlive(False);
pil2.addShutter('fs')
...
pil2sum = AnalyserDetectorClass("pil2sum", pil2, [SumProcessor()], panelName="Pilatus 2", iFileLoader=PilatusTiffLoader);
...
pil2stats = AnalyserDetectorClass("pil2stats", pil2, [MinMaxSumMeanDeviationProcessor()], panelName="Pilatus 2", iFileLoader=PilatusTiffLoader);
pil2stats.setAlive(True);
pil2stats.readoutNexus = True

print "Usage: use pil2fit for peak fitting"
pil2fit = AnalyserDetectorClass("pil2fit", pil2, [TwodGaussianPeak()], panelName="Pilatus 2", iFileLoader=PilatusTiffLoader);
...
pil2roi = AnalyserWithRectangularROIClass("pil2roi", pil2, [MinMaxSumMeanDeviationProcessor()], panelName="Pilatus 2", iFileLoader=PilatusTiffLoader);
...
pil2roisum = AnalyserWithRectangularROIClass("pil2roisum", pil2, [SumProcessor()], panelName="Pilatus 2", iFileLoader=PilatusTiffLoader);
...
mroi = AnalyserWithMovingRectangularROIClass("mroi", pil2, [MinMaxSumMeanDeviationProcessor()], panelName="Pilatus 2", iFileLoader=PilatusTiffLoader);
