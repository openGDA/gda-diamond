...
sdcdtheta=DoubleCrystalDeflectorClass("sdcdtheta", motorWavelength, motorTheta, motorOmega, motorGamma, [diff1vdelta, diff1vgamma], [dcdx_rot])
...
dcdx_rot_dummy = DummyScannable('dcdx_rot_dummy')
dummydcdtheta=DoubleCrystalDeflectorClass("dummydcdtheta", testMotor1, testMotor4, testMotor5, testMotor6, [diff1vomega, diff1vdelta], [dcdx_rot_dummy]);
