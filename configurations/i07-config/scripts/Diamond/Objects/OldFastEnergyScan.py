...
class FastEnergyScanClass:
	...
	def setEnergyRange(self, startEnergy, endEnergy):
		self.startEnergy.caput(startEnergy)
		self.endEnergy.caput(endEnergy)
	...
	def plotData(self):
		...
		dvp.plot("Data Vector", dataSetEnergyPGM, [dataSetChannel01, dataSetChannel02, dataSetChannel03, dataSetChannel04]);
