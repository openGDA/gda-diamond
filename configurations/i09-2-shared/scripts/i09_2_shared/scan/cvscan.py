...
from i09_2_shared.scannable.continuous.continuous_jenergy_scannable_instances import jenergy_move_controller
from gda.configuration.properties import LocalProperties
if str(LocalProperties.get("gda.beamline.name")) == "i09":
    from scannable.continuous.continuous_ienergy_scannable_instances import ienergy_move_controller
