...
class MiroXgraph():
	...
	def sanity_check(self, nframes_post_trigger, exposure_time_sec, acq_period_sec, download_option, overhead_sec = 2e-6):
	...
	def collect_data(self, nframes_post_trigger, exposure_time_sec, frame_rate_hz, download_option, black_ref=False, interactive_run=False, cine_num=1, pre_download_sleep_sec=1.0, nxs=True, overhead_sec=2e-6):
		"""
		...
		black_ref: True or False to indicate if a black reference image is to be collected beforehand; default=False
		...
		overhead_sec: the amount of time in seconds to wait due to the Miro overhead; default=2e-6
		"""
		import inspect
		...
		self.sanity_check(nframes_post_trigger, exposure_time_sec, acq_period_sec, download_option, overhead_sec)
