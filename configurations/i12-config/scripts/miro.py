...
class MiroXgraph():
	...
	def sanity_check(self, nframes_post_trigger, exposure_time_sec, acq_period_sec, download_option):
		...
		if acq_period_sec < exposure_time_sec:
			print "Acquisition period of %.3f s is smaller than the exposure time: using the value of the exposure time of %.3f instead!" %(acq_period_sec, exposure_time_sec)
...
print("Creating miro_radiograph object in GDA...")
miro_xgraph=MiroXgraph()
print("Finished creating miro_radiograph object in GDA!")
