...
def moveToBeamEnergy(target_energy):
    ...
    c1 = - (dnp.array([-2067.17, -1328.7, -1172.1]) + c1_offset)/1000
    c2 = - (dnp.array([-2135.937, -1412.3, -1257.0]) + c2_offset)/1000
    z =   dnp.array([668.1, 1012.9, 1136.9]) + z_offset
    E = dnp.array([53.0, 80.21, 90.00])
    cam = dnp.array([7.96, -71.87, -89.25])
