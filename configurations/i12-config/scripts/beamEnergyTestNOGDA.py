...
def calcMotorPositionsForEnergy(target_energy,cap1,cap2):
    ...
    cam = 3141.6 * dnp.tan(z_factor/target_energy)
...
try:
    ...
    print("Finder section did not work, or was not required ")
...
def testBeamEnergyNew(target_energy):
    ...
    d11=caget("BL12I-OP-DCM-01:BEND:XTAL1:CAP1")
    d12=caget("BL12I-OP-DCM-01:BEND:XTAL1:CAP2")
    d21=caget("BL12I-OP-DCM-01:BEND:XTAL2:CAP1")
    d22=caget("BL12I-OP-DCM-01:BEND:XTAL2:CAP2")
    ...
    #call the routine to calculate the positions
...
print "finished loading 'testBeamEnergyNew' "
