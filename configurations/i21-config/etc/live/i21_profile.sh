...
export PATH=/dls_sw/i21/software/anaconda2/bin:/dls_sw/prod/etc/Launcher:/dls_sw/$BEAMLINE/software/gda/config/bin:/dls_sw/$BEAMLINE/software/gda/pythonscript:${PATH}
