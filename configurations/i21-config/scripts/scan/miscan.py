...
print("    Syntax: miscan (scannable1, scannable2) [(1,2), (3,4),(5,6)] andor 10 0.1")
...
def miscan(*args):
    ...
    a more generalised scan that extends standard GDA scan syntax to support 
        ...
        4. syntax 'miscan andor 10 0.1 ...' is supported for collecting 10 images at a single point.
