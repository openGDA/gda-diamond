...
from __main__ import smplXPositioner,smplYPositioner,smplZPositioner,smplRZPositioner,smplTiltPositioner,smplAzimuthPositioner,m5tthPositioner,smplDiodetthPositioner,x,y,z,th,chi,phi,m5tth,delta  # @UnresolvedImport
import installation
...
if installation.isLive():
    ...
    deltaval = PositionerValue("deltaval", smplDiodetthPositioner, "BL21I-EA-SMPL-01:MTP:DRING")  
else:
    ...
    deltaval = DummyPositionerValue("deltaval", smplDiodetthPositioner, delta, positions={"Screws":1.0, "Transfer":2.0, "RIXS": 3.0})  
...
smp_positioner = SamplePositioner("smp_positioner",
                                ...
                                x, y, z, th, chi, phi, m5tth, delta,  
                                xval, yval, zval, thval, chival, phival, m5rotval, deltaval, tolerance=0.001)
