...
energy1=BeamEnergy("energy1",idphase, idgap, energycff1,lut="IDCalibrationTable.txt")  # @UndefinedVariable
energy2=BeamEnergy("energy2",idphase, idgap, energycff2,lut="IDCalibrationTable.txt")  # @UndefinedVariable
energy3=BeamEnergy("energy3",idphase, idgap, energycff3,lut="IDCalibrationTable.txt")  # @UndefinedVariable
