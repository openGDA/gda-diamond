...
from gdaserver import sgmpitch, sgmx, s5v1gap, spech, fastshutter  # @UnresolvedImport
...
scan(sgmx, sgmx_start, sgmx_end, sgmx_step, sgmpitch_spech_scannable_group, sgmpicth_spech_pair_positions, detector_to_use, exposure_time)
