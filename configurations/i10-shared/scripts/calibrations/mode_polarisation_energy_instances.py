...
from calibrations.energy_polarisation_class import BeamEnergyPolarisationClass, X_RAY_POLARISATIONS
...
print("    5. 'laa'        - a scannable to set and get the angle of polarisation of the X-ray beam in Linear Arbitrary (la) mode")
