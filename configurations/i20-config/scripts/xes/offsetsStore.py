...
global DEFAULT_STORE_NAME,STORE_DIR,STORE_IN_USE_NAME,CURRENT_OFFSET
...
class XESOffsets:
    ...
    def __init__(self):
        self.current_store_tracker = 'none'
    ...
    def getName(self):
        return self.current_store_tracker
    ...
    def write(self):
        ...
        """
        self.writeas(TEMP_STORE_NAME)
    
    def writeas(self, storeName):
        """
    ...
    def applyfrom(self, storeName):
        ...
        self.writeas(STORE_IN_USE_NAME)
        print "Offsets applied."
        self.current_store_tracker=storeName
        
    def viewstore(self, storeName):
        """
    ...
    def current(self):
        ...
        for scannable in scannables:
            ...
            if offset == None:
                offset = [0]
            offset = offset[0]
            print "%20s : %.9f" % (name, offset)
    
    
    def removeAllOffsets(self):
        """
