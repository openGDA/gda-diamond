...
def integrate(filepath="/dls/i13-1/data/2011/mt5659-1/733.nxs", motor="energyThreshold"):
    """
...
def integrate_save_plot(filepath="/dls/i13-1/data/2011/mt5659-1/733.nxs", motor="energyThreshold", plotname="Plot 2",
                        outputFile=""):
