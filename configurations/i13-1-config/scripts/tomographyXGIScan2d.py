...
def tomoXGIScan2d(inBeamPosition, outOfBeamPosition, exposureTime=1, start=-90., stop=90., step=0.1, startGratingOuter=0., stopGratingOuter=13.0, stepGratingOuter=1.0, startGratingInner=0., stopGratingInner=13.0, stepGratingInner=1.0, darkFieldInterval=0., flatFieldInterval=0.,
    ...
    darkFieldInterval - number of projections (ie projection frames as opposed to projection series) between any two consecutive dark-field collections (default = 0, for not taking any intermediate darks) 
    ...
    flatFieldInterval - number of projections (ie projection frames as opposed to projection series) between any two consecutive flat-field collections (default = 0, for not taking any intermediate flats))
...
#            raise NameError("tomography_optimizer is not defined in Jython namespace")
        ...
        if tomography_grating_translation_outer is None:
            raise NameError("tomography_grating_translation_outer is not defined in Jython namespace")
        ...
        if tomography_grating_translation_inner is None:
            raise NameError("tomography_grating_translation_inner is not defined in Jython namespace")
