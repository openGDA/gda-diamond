...
def addNXTomoSubentry(scanObject, tomography_detector_name, tomography_theta_name, tomography_beammonitor_name):
    ...
    nxLinkCreator.setControl_data_target("entry1:NXentry/instrument:NXinstrument/" + tomography_beammonitor_name + ":NXpositioner/" + tomography_beammonitor_name + ":NXdata")
    ...
    nxLinkCreator.setSample_x_translation_target("entry1:NXentry/before_scan:NXcollection/t1:NXcollection/t1_sx:NXdata")
    nxLinkCreator.setSample_y_translation_target("entry1:NXentry/before_scan:NXcollection/t1:NXcollection/t1_sy:NXdata")
    nxLinkCreator.setSample_z_translation_target("entry1:NXentry/before_scan:NXcollection/t1:NXcollection/t1_sz:NXdata")
