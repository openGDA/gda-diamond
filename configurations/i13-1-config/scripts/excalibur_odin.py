...
i13_1NumTracker = NumTracker('i13-1')
...
class ExcaliburOdinXgraph():
    ...
    def collect_data(self, exposure_time_sec, acq_period_sec, nimages, primed=False):
        ...
        self.scan_number = i13_1NumTracker.getCurrentFileNumber() + 1
        i13_1NumTracker.incrementNumber()
...
#        #sleep(nimages*acq_per_rbv*(2.5))
    ...
    def generate_vds(self, scriptpath="/dls_sw/prod/tools/RHEL6-x86_64/defaults/bin/dls-vds-gen.py"):
        ...
        for i in range(nfiles):
            cmd += node_filename_template %(self.scan_number, i)
        ...
        print("Finished waiting for the interleaved VDS file %s to appear on the file system!" %(interleaved_fpath.strip()))
