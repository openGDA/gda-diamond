...
def test_single_point_scan_is_not_refused():
	...
	collect_pe2(sampleid="bkg", exposure_time=9, frames=1, monitorsPerScan=['sampleID_recorder'],
...
def test_multiple_point_scan_completes():
	...
	collect_pe2(sampleid="bkg", exposure_time=9, frames=2, monitorsPerScan=['sampleID_recorder'],
				monitorsPerPoint=[],comment="",f2="auto",preSleep=None,blocking=True,samX=None)
