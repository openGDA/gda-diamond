...
def setupMedipixPlugins() :
    ...
    #Setup the FFI0 plugin with the buffered scaler and detector names
    medipix_FFI0=medipix.getAdditionalPluginList()[1]
    medipix_FFI0.setBufferedScaler(qexafs_counterTimer01)
    medipix_FFI0.setBufferedNxDetector(qexafs_medipix)
