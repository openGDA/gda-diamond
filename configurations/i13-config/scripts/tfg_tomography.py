...
Jython script for TFG2 controlled PCO acquisition
 for Peter Lee's Rig (taking a input pulse to start motion, and give out an output pulse when move completed)
...
def tfgscan(nproj, exposure):
    ...
    cac.caput("BL12I-EA-DET-02:TIF:FilePath",winprojfolder,False,True)
    cac.caput("BL12I-EA-DET-02:TIF:FileName","p_",False,True)
    cac.caput("BL12I-EA-DET-02:TIF:FileTemplate","%s%s%05d.tif",False,True)
