...
jitpv="BL12I-EA-CAM-01:ZOOM.VAL"
jitrbv="BL12I-EA-CAM-01:ZOOM.RBV"
scanidx=0
flatidx=0
...
def doflat(nflat=5):
   ...
   caput("BL12I-EA-DET-02:TIF:FileName","f_%i_" % flatidx,datatype=DBR_CHAR_STR)
...
def doscan(nsteps=1800,exposure=0.3,readout=0,jitter=False):
   global basejit
   global jitarray
   global trigpv
   global jitpv
   ...
   caput ("BL12I-EA-DET-02:TIF:FileNumber",0,wait=False)
   caput("BL12I-EA-DET-02:TIF:FileName","p_%i_" % scanidx,datatype=DBR_CHAR_STR)
   caput ("BL12I-EA-DET-02:TIF:Capture",1,wait=False)
...
folderstr="/data/2011/cm2061-4/processing/rawdata/"
