...
def printusage():
   ...
   print("default: nsteps=16 cstep=1")
...
""") % (reconprogram)
   ...
   try:
         ...
         if (holdflag == 1 ):
            thispid=os.spawnlpe(os.P_WAIT,"qsub","qsub", "-P","i12","-e",mypath, "-o", mypath,holdstring,holdname, "-q",myqueue,"-N",jobname,"-cwd","-pe","smp","4","-t","%i-%i" % (1,nsteps),myscript, qenviron)
         else:
