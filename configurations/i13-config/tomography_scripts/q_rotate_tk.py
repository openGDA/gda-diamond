...
#set some defaults
entries[0].insert(0,"/dls/i12/data/2010/cm1898-4/processing/2544-fossil/")
entries[1].insert(0,"pr_correct")
entries[2].insert(0,"/dls/i12/data/2010/cm1898-4/processing/2544-fossil/pr_correct/")
entries[3].insert(0,"medfilt")
...
labels[4].config(text="Rotation Angle")
