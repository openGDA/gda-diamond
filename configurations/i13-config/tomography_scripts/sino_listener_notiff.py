...
#$Id: sino_listener_notiff.py 214 2012-02-13 15:46:36Z kny48981 $
import getopt
import sys
import os
import commands
...
def usage():
   svnstring="$Id: sino_listener_notiff.py 214 2012-02-13 15:46:36Z kny48981 $"
   global interval
   global lt
...
#locate or create the output folders
   ...
   chunkprogram="sino_chunk_q_notiff" #use the path ... 
