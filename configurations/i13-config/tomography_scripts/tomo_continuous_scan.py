...
# $Id: tomo_continuous_scan.py 222 2012-02-29 13:30:17Z kny48981 $
...
class folders:
   ...
   def setbasefolders(self,sname):
      #self.base="/data/2012/ee7434-1/processing/rawdata/"
      self.base="/data/2012/ee7434-2/tmp/"
...
doflat(fpath,nflats,flat_exp,"ff1%s"%scanname)
...
print("calling doflat")
camera.setup(flat_exp)
doflat(fpath,nflats,flat_exp,"ff2%s"%scanname)
