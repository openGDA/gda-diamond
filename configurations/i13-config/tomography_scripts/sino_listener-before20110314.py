...
def main():
   ...
   try:                                
      opts, args = getopt.gnu_getopt(sys.argv[1:],  "U:O:C:EGI:J:N:R:STZ:b:cdf:hi:j:l:n:o:p:s:vw:xz:Q:")
...
""") % (mypid,jobbasename)
  ...
  #    sys.exit(147)
   try:
         ...
         thispid=os.spawnlpe(os.P_WAIT,"qsub","qsub", "-v","I12STRIPBYTES","-P","i12","-e",settingsfolder, "-o", settingsfolder, "-q",myqueue,"-N",jobname,"-cwd","-pe","smp","4","-t","%i-%i" % (firstchunk,nchunks),chunkscript, qenviron)
