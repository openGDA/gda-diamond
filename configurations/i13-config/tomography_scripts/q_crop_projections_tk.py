...
#calculate the derived values
   ...
   """) % (infolder,outfolder,flatname,cflatname,chunksize,lasttask,lastchunk,medflag,xstart,ystart,xsize,ysize) 
...
entries[1].insert(0,"ee2071-1")
entries[2].insert(0,"1020")
entries[3].insert(0,"1801")
