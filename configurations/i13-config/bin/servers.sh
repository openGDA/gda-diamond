...
nohup ${GDAFOLDER}/plugins/uk.ac.gda.core/bin/gda  --smart --trace --config=$GDAFOLDER/$BEAMLINE-config --restart -v --mode=$GDAMODE nameserver > $LOGFILE 2>&1 &
nohup ${GDAFOLDER}/plugins/uk.ac.gda.core/bin/gda  --smart --trace --config=$GDAFOLDER/$BEAMLINE-config --restart -v --mode=$GDAMODE logserver > $LOGFILE 2>&1 &
nohup ${GDAFOLDER}/plugins/uk.ac.gda.core/bin/gda  --smart --trace --config=$GDAFOLDER/$BEAMLINE-config --debug -p 8002 --restart -v --mode=$GDAMODE eventserver > $LOGFILE 2>&1 &
nohup ${GDAFOLDER}/plugins/uk.ac.gda.core/bin/gda  --smart --trace --config=$GDAFOLDER/$BEAMLINE-config --debug -p 8001 --restart -v --mode=$GDAMODE objectserver > $LOGFILE 2>&1 &
