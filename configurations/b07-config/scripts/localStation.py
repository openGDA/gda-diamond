...
sm21b_list = [sm21b_x,sm21b_y,sm21b_z,sm21b_roty,sm21b_y_positioner] # @UndefinedVariable
sm52b_list = [sm52b_x,sm52b_y,sm52b_z,sm52b_roty,sm52b_xp,sm52b_yp,sm52b_zp] # @UndefinedVariable
