...
if installation.isLive():
	...
	print("-"*100)
	print("Note: Use object name 'scmc' for the Superconducting Magenet control")
	scmc = SuperconductingMagnetClass('scmc', magRootPV);
	
	print("Note: Use Pseudo device name 'magmode' for the Superconducting Magenet mode control")
	magmode = ModeMagnetClass('magmode', 'scmc');
	
	print("Note: Use Pseudo device name 'magcartesian' for the Superconducting Magenet control in Cartesian coordinate")
	magcartesian = CartesianMagnetClass('magcartesian', 'scmc');
	
	print("Note: Use Pseudo device name 'magspherical' for the Superconducting Magenet control in Spherical coordinate")
	magspherical = SphericalMagnetClass('magspherical', 'scmc');
	
	print("Note: Use Pseudo device name 'magx, magy, magz, magrho, magth, magphi' for the Superconducting Magenet uniaxial control")
	magx = SingleAxisMagnetClass('magx', 'scmc', SingleAxisMagnetClass.X)
	magy = SingleAxisMagnetClass('magy', 'scmc', SingleAxisMagnetClass.Y)
	magz = SingleAxisMagnetClass('magz', 'scmc', SingleAxisMagnetClass.Z)
	magrho = SingleAxisMagnetClass('magrho', 'scmc', SingleAxisMagnetClass.RHO)
	magth  = SingleAxisMagnetClass('magth',  'scmc', SingleAxisMagnetClass.THETA)
	magphi = SingleAxisMagnetClass('magphi', 'scmc', SingleAxisMagnetClass.PHI)
	magdelay=scmc.delay
	magtolerance=scmc.tolerance
