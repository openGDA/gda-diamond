...
class SampleMotionI15Test(unittest.TestCase):
    ...
    tests={  '0a': {'mu':0, 'phi':58+ 0, 'sx': 0, 'sy':1, 'sperp': 0,                   'spara':1},
           ...
           'M45b': {'mu':0, 'phi':58-45, 'sx':-1, 'sy':0, 'sperp': 0.7071067811865475, 'spara':-0.7071067811865475},
           'P45b': {'mu':0, 'phi':58+45, 'sx':-1, 'sy':0, 'sperp': 0.7071067811865475, 'spara': 0.7071067811865475},
           }
    #"""
