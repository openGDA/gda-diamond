...
#from poms.scannables.colbyDelayLineScannableRS232 import DelayLineClass

#"""NOTE: Whichever serial port you select, make sure that you are using
#         either a NULL MODEM cable, or a NULL MODEM adapter."""


#delay=DelayLineClass('delay', 'BL10I-EA-USER-01:SER4.AOUT',
#    'BL10I-EA-USER-01:SER4.TINP', 'BL10I-EA-USER-01:SER4.IEOS',
#    '%', '%.15f', 'Colby PDL-100A Programmable Delay Line')

#print 'On BLADE Synoptic, select UI1, then Serial Ch 4, then make'
#print "sure that both output terminator is \\r\\n"
