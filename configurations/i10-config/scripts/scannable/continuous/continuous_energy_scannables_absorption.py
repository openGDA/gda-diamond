...
print("   'mcs16', 'mcs17', 'mcs18', 'mcs19', 'mcs20', 'mcs21', 'mcs22', 'mcs23'- EM scannables used in 'cvscan' to collect data from MCS channel 17, 18, 19, 20, 21, 22, 23, 24 on SCALAR 3, respectively")
...
mcs16 = WaveformChannelScannable('mcs16', mcs_em_controller, 17); mcs16.setHardwareTriggerProvider(energy_controller); mcs16.verbose=True
mcs17 = WaveformChannelScannable('mcs17', mcs_em_controller, 18); mcs17.setHardwareTriggerProvider(energy_controller); mcs17.verbose=True
mcs18 = WaveformChannelScannable('mcs18', mcs_em_controller, 19); mcs18.setHardwareTriggerProvider(energy_controller); mcs18.verbose=True
mcs19 = WaveformChannelScannable('mcs19', mcs_em_controller, 20); mcs19.setHardwareTriggerProvider(energy_controller); mcs19.verbose=True
mcs20 = WaveformChannelScannable('mcs20', mcs_em_controller, 21); mcs20.setHardwareTriggerProvider(energy_controller); mcs20.verbose=True
mcs21 = WaveformChannelScannable('mcs21', mcs_em_controller, 22); mcs21.setHardwareTriggerProvider(energy_controller); mcs21.verbose=True
mcs22 = WaveformChannelScannable('mcs22', mcs_em_controller, 23); mcs22.setHardwareTriggerProvider(energy_controller); mcs22.verbose=True
mcs23 = WaveformChannelScannable('mcs23', mcs_em_controller, 24); mcs23.setHardwareTriggerProvider(energy_controller); mcs23.verbose=True
