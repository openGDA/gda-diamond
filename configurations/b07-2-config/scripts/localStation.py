...
print ("Importing XAS autogeneration functions from /dls_sw/b07-2/scripts/Beamline/XAS_autogen_v2.py")
execfile("/dls_sw/b07-2/scripts/Beamline/XAS_autogen_v2.py")
print ("Done")
print "-----------------------------------------------------------------------------------------------------------------"
