...
# following line required when use NexusScanDataWriter instead of NexusDataWriter
# from gdascripts.metadata.nexus_metadata_class import meta
# use NexusDataWriter
from metadata.metashop import meta_add, meta_rm
