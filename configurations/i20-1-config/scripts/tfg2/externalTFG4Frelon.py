...
numberOfAccumulationPerSpectrum=5
...
def collectNumberFramesFromDetector(totalNumberOfAccumulations):
    return str(totalNumberOfAccumulations)+" 0 0.000001 0 0 0 9 \n"
...
def getCommands4ExternalTFG():
    ...
    command += collectNumberFramesFromDetector(numberOfSpectrum*numberOfAccumulationPerSpectrum-30)
