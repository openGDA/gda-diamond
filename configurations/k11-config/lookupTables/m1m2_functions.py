...
@author: xgn26134
"""
from gdaserver import dummy_m2_bendds
...
def m2_bender_current_position_check(energy):
    ...
    m2_current_bendus_position = dummy_m2_bendus.getPosition() # where benders are
    m2_current_bendds_position = dummy_m2_bendds.getPosition()
...
def m2_bender_move_monoDiff():
    # move to center
    dummy_m2_bendus.asynchronousMoveTo(18000)
    dummy_m2_bendds.asynchronousMoveTo(235000)
    dummy_m2_bendus.waitWhileBusy()
    dummy_m2_bendds.waitWhileBusy()
    # move to position
    dummy_m2_bendus.asynchronousMoveTo(176365)
    dummy_m2_bendds.asynchronousMoveTo(231365)
    dummy_m2_bendus.waitWhileBusy()
    dummy_m2_bendds.waitWhileBusy()
