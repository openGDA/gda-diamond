...
rga21H2O = EpicsMonitorClass('rga21H2O', 'BL07C-VA-RGA-21:BAR:M18', 'mbar', '%.2e')
rga21CO = EpicsMonitorClass('rga21CO', 'BL07C-VA-RGA-21:BAR:M28', 'mbar', '%.2e')
rga21O2 = EpicsMonitorClass('rga21O2', 'BL07C-VA-RGA-21:BAR:M32', 'mbar', '%.2e')
rga21AR = EpicsMonitorClass('rga21AR', 'BL07C-VA-RGA-21:BAR:M40', 'mbar', '%.2e')
rga21CO2 = EpicsMonitorClass('rga21CO2', 'BL07C-VA-RGA-21:BAR:M44', 'mbar', '%.2e')
rga21CF3 = EpicsMonitorClass('rga21CF3', 'BL07C-VA-RGA-21:BAR:M69', 'mbar', '%.2e')
