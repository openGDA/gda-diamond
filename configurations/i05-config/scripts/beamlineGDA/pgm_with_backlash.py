...
pgm_gtrans_bl = pgm_trans_backlash("pgm_gtrans_bl",Finder.find("pgm_gtrans"),backlash = 1.00)
pgm_mtrans_bl = pgm_trans_backlash("pgm_mtrans_bl",Finder.find("pgm_mtrans"),backlash = 1.00)
