...
Usage:
  ...
  pos stokes_pars [1, 0, 0]  # define incident beam Stokes parameters P1,P2,P3
...
class StokesParameters(ScannableMotionBase):
    ...
    Usage:
        stokes_pars = StokesParameters('stokes_pars')
        pos stokes_pars [1, 0, 0]  # linear horizontal
        pos stokes_pars [-1, 0, 0]  # linear vertical
        pos stokes_pars [0, 1, 0]  # Linearly polarized (+45Deg)
        pos stokes_pars [0, -1, 0]  # Linearly polarized (-45Deg)
        pos stokes_pars [0, 0, 1]  # circular right
        pos stokes_pars [0, 0, -1]  # circular left
    """

    def __init__(self, name):
        self.setName(name)
        self.setInputNames(['p1', 'p2', 'p3'])
        self.setExtraNames([])
        self.setOutputFormat(['%.4f','%.4f','%.4f'])
        self.setLevel(3)
        self.p1 = 1.
        self.p2 = 0.
        self.p3 = 0
    ...
    def asynchronousMoveTo(self, stokes_parameters):
        self.p1, self.p2, self.p3 = stokes_parameters
