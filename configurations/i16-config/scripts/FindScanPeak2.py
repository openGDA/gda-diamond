def FindScanPeak2(ordinateName, printNameList=[], abscissaNameList=[], scanID=0, peakRatio=-1, ToPrint=1):
...
def readSRSDataFile(filepath):
	...
	try:
		...
		raise IOError, 'Failed to read SRS data file: Could not open file: ', filepath
