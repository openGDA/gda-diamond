...
def OP2(hkl0,dd=.2,dd2=.2,counter=t,tt=.1):
	step=2*dd/40.
	step2=2*dd2/40.
	hkl(hkl0)
	eta0=eta()
...
def OP3(hkl0,dd=.2,dd2=.2,counter=APD,tt=.1):
	step=2*dd/30.
	step2=2*dd2/30.
	hkl(hkl0)
	eta0=eta()
