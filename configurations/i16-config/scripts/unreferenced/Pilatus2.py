...
class PilatusClass(ScannableMotionBase):
	...
	def getPosition(self):
		...
		if self.process_image:
			...
			self.sum=self.image.sum()#(self.image.doubleArray())
		else:
			self.sum = -1
			self.maxpix = -1			
		# display
		if self.display_image:
			if self.logscale:
				Plotter.plotImage("Pilatus100k", self.data.getImage().lognorm())
			else:
				Plotter.plotImage("Pilatus100k", self.data.getImage().norm())
		# return
...
### IMPORTANT: For now, please use  PilatusClassWithRobustLoading not the older PilatusClass --- Sorry, Rob ###

#pil100k=PilatusClassWithRobustLoading('P100k','BL16I-EA-PILAT-01:','/dls/i16/data/2009/mt0/run2/Pilatus100k/','p',10)
pil100k=PilatusClassWithRobustLoading('P100k','BL16I-EA-PILAT-01:','/dls/i16/data/2009/mt1159-1/Pilatus100k/','p',10)
...
#to create filder if it doesn't exist
#from java.io import File
#f=File('/dls/i16/data/2009/mt1159-1/Pilatus100k')
#f.mkdirs()
...
pil2m=PilatusClassWithRobustLoading('P2M','BL16I-EA-PILAT-02:','/dls/i16/im/','test',10, display_image=1, process_image=1, logscale=1)
