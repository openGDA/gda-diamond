#print "<<< Entering: startup_diffractometer_euler_for_diffcalc.py ..."
#
...
#euler = EulerKappa('euler', sixckappaDC, True)
#phi = euler.phi
#chi = euler.chi 
#eta = euler.eta
#exec("mu=euler.mu")
...
#exec("gam=euler.gam")
#print "... Leaving: startup_diffractometer_euler_for_diffcalc.py >>>"
#
#
