...
#		self.setExtraNames(['FileNum','sum','max','min']);
#		self.Units=['s']
#		self.setOutputFormat(['%.2f', '%.0f', '%.0f', '%.0f','%.0f'])
#		self.setLevel(9)
...
#		else:
#			sleep(.5)
#		return [self.exposuretime() self.filenumber()-1,self.sum, self.maxpix, self.minpix]
#		print 'getpos end'
#
#	def asynchronousMoveTo(self,newpos):
##		print 'moveto start'
