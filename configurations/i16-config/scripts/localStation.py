...
#	checkbeam=WaitForBeamPDClass('BeamOK',ic1monitor,1); checkbeam.command_string='None'
	...
	checkbeam=WaitWhileScannableBelowThreshold("BeamOk", ic1monitor, 1, 1, 1, id1gap=idgap)
...
mono_diode=MoveScalarPDsToPresetValuesClass('mono_diodes',[d3a,d3d,d4a,d4d,d5a,d5d],[[90,11,20,10,20,12],[90,50.5,20,10,20,12],[90,10,20,53,20,12],[90,10,20,11,20,52]],help='0=all out; 1=d3d diode in, 2=d4d diode in; 3=d5diode in')  # @UndefinedVariable
...
try:
	...
	camd3, camd3_peak2d, camd3_max2d = wrappedDetector("camd3", _camd3, _camd3_for_snaps, panel_name_rcp='CAMD3')
	camd4, camd4_peak2d, camd4_max2d = wrappedDetector("camd4", _camd4, _camd4_for_snaps, panel_name_rcp='CAMD4')
	camd5, camd5_peak2d, camd5_max2d = wrappedDetector("camd5", _camd5, _camd5_for_snaps, panel_name_rcp='CAMD5')
except:
