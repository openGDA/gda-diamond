...
ccd = ProcessingDetectorWrapper('ccd', ccddet, [], root_datadir='/dls/i16/data/2012/mt7277-1/', panel_name='Pilatus 100k', iFileLoader=TIFFImageLoader, fileLoadTimout=24*3600) 
