...
class HklEuler(ScannableMotionWithScannableFieldsBase):
	'''
	'''
	...
	def setOperatingContinuously(self, b):
		self.euler.setOperatingContinuously(b);

	def isOperatingContinously(self):
		return self.euler.isOperatingContinously()

	def getContinuousMoveController(self):
		return self.euler.getContinuousMoveController()
