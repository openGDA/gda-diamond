...
if installation.isLive():
    from epics.hexapod.hexapod import Hexapod,HexapodAxis
    ...
    hpx=DummyScannable('hpx')
    hpy=DummyScannable('hpy')
    hpz=DummyScannable('hpz')
    hpc=DummyScannable('hpc')
    hpb=DummyScannable('hpb')
    hpa=DummyScannable('hpa')
