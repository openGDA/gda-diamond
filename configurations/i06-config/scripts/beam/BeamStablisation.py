...
cb1 = BeamStablisationUsingAreaDetectorRoiStatPair(rois, leem_FOV_A, leem_rot, m4fpitch, m5fpitch, psphi, roistat_index=[1, 2, 3, 4], pvRootName="BL06I-EA-DET-01", detector=medipix, roi_provider_name="medipix_roi")
cb1.max_error = 0.01
...
cb = BeamStablisationUsingExtraRoiStatPair(rois, leem_FOV_A, leem_rot, m4fpitch, m5fpitch, psphi, roistat_index=[7, 8, 9, 10], pv_root_name="BL06I-EA-DET-01")
cb.max_error = 0.01
