...
if "peemBridge" in globals() or "peemBridge" in locals():
    try:
...
d1=['peemBridge','leem', 'ca71', 'startVoltage', 'objective', 'uview', 'uviewROI1', 'uviewROI2', 'uviewROI3', 'uviewROI4', 'uv', 'uvroi', 'roi1','roi2', 'roi3', 'roi4'];
#d2=[peemBridge, leem, ca71, startVoltage, objective, uview, uviewROI1, uviewROI2, uviewROI3, uviewROI4, uv, uvroi, roi1,roi2, roi3, roi4];

devices = ['peemBridge']
devices.extend( ['leem', 'ca71', 'startVoltage', 'objective'] )
devices.extend( ['uview', 'uviewROI1', 'uviewROI2', 'uviewROI3', 'uviewROI4'] )
devices.extend( ['uv', 'uvroi', 'roi1','roi2', 'roi3', 'roi4'] )

UtilFunctions().removeDevices(devices);

print "-------------------------------------------------------------------"
print "Set up the Corba Bridge Connection"

try:
    peemBridge = CorbaBridgeConnection();
    peemBridge.configure()
except:
...
leem =ElmitecPEEM()
leem.setCorbaBridgeName("peemBridge")
leem.configure()
...
uview = UViewImageDetector()
uview.setCorbaBridgeName("peemBridge")
uview.setTracker("peem")
uview.setImageDir("peem")
uview.configure()
