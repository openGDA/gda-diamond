...
objAlignX = LEEM_Scannable_Class('objAlignX',"mAmp", 36)
objAlignY = LEEM_Scannable_Class('objAlignY',"mAmp", 37)
leem_temp = LEEM_Scannable_Class('leem_temp',"deg", 39)
leem_rot = LEEM_FOV_Rotation_Class('leem_rot')