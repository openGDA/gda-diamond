...
try:
    ...
    mcpScreen = LEEM2000_tcp.leem_scannable("mcpScreen", "val 104", '%.3', leem2000); mcpScreen.readOnly=True
    mcpPlate = LEEM2000_tcp.leem_scannable("mcpPlate", "val 105", '%.3', leem2000); mcpPlate.readOnly=True
except:
