...
filenames = []
for run_num in range(95059,95111):
    for file in range(1, 16):
        filenames.append("/dls/i11/data/2011/in1992-1/%d-mythen-%04d.dat" % (run_num, file))
print "%d filename(s) specified" % len(filenames)

# this will contain the new, summed data
new_summed_data_file = "/dls/i11/data/2011/in1992-1/processing/rf_test.dat"
