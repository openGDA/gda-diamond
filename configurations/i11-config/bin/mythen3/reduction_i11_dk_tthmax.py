...
def mask_and_histogram(
    ...
    #print(bins[3093:3100])
    #print(histogram[3093:3100])
    #print(histogram_bin_counts[3093:3100])
...
def enlarge_the_gaps(array, starts, ends, enlargement_factor=10):
...
def do_the_overall_sum(fh, xye_filepath, deltas):
    ...
    x = np.arange(low_x, high_x + step + step, step)
