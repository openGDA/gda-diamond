#!/bin/bash
# Reads or rewrites the beamline specific 'launch' link as requested. This allows Data
# Acquisition staff to latch the GDA9 application that will be started by the launcher
...
RELEASE_VERSION_SCRIPT="$MY_WORKSPACE_PARENT/workspace_git/gda-diamond.git/dls-config/bin/read_release_version.sh"
