...
export GDA_DLS_CONFIGDIR=${GDAFOLDER}/workspace_git/gda-diamond.git/dls-config
...
nohup python ${GDAFOLDER}/workspace_git/gda-core.git/uk.ac.gda.core/bin/gda  --smart --trace --config=$GDA_CONFIGDIR --restart -v --mode=$GDAMODE --properties=${GDA_DLS_CONFIGDIR}/properties/common.properties logserver > $LOGFILE 2>&1 &
sleep 2
