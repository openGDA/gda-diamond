...
class BeamEnergyPolarisationClass(ScannableMotionBase):
    ...
    def __init__(self, name, idctrl, pgmenergy, idlamlookup, lut="JIDEnergy2GapCalibrations.txt", energyConstant=False, polarisationConstant=False):
...
#energypolarisation.setInputNames(["jenergy"])
