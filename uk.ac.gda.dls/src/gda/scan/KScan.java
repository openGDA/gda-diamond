...
public class KScan extends ScanBase {
	 ...
	 *            Object
	 */
	public KScan(Scannable ve, Object start, Object stop, Object step, Object kStartTime, Object kEndTime,
			Object kWeighting, Object edgeEnergy, Object twoD) {
		...
		this.twoD = Double.parseDouble(twoD.toString());
		setUp();
	}

	/**
	 * A static method to create a scan which has a nested scan inside it. To run the scan, call the runKScan() method.
	 * For example, in Jython: from gda.scan import KScan; myScan =
	 * KScan.create(tth,10,12,0.1,KScan.create(phi,20,30,1)); myScan.runKScan()
	 * 
	 * @param ve
	 *            the scannable
	 * @param start
	 ...
	 */
	public KScan(Scannable ve, Object start, Object stop, Object step, Object kStartTime, Object kEndTime,
			Object kWeighting, Object edgeEnergy, Object twoD, Scan childScan) {
		allScannables.add(ve);
		this.start = Double.parseDouble(start.toString());
		this.stop = Double.parseDouble(stop.toString());
		this.step = Double.parseDouble(step.toString());
	 ...
	 */
	public static void runKScan(Scannable ve, Object start, Object stop, Object step, Object kStartTime,
			Object kEndTime, Object kWeighting, Object edgeEnergy, Object twoD, Scan childScan)
			throws InterruptedException, Exception {
		KScan thisScan = new KScan(ve, start, stop, step, kStartTime, kEndTime, kWeighting, edgeEnergy, twoD, childScan);
		thisScan.runScan();
	}

	/**
	 * mDegForK converts k value (in inverse angstroms) to mDeg by using the java Converter class.
	 * 
	 * @param k
	 *            double
	 * @return double
	 */
	public double mDegForK(double k) {
		return Converter.convert(k, Converter.PERANGSTROM, Converter.MDEG,
				edgeEnergy, twoD);
	}
