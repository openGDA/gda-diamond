...
public interface SampleMovementService extends Findable {
	 ...
	 */
	void moveSampleByMicronsAlongStandardAxes(double h, double v, double b) throws DeviceException;

	/**
	 * Moves the sample along the beamline's goniometer axes.
	 */
	void moveSampleByMicronsAlongBeamlineAxes(double x, double y, double z) throws DeviceException;
}
