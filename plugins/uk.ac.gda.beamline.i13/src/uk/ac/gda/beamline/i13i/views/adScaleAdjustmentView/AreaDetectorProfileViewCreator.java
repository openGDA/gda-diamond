...
public class AreaDetectorProfileViewCreator implements IExecutableExtensionFactory, IExecutableExtension{
	private static final Logger logger = LoggerFactory.getLogger(AreaDetectorProfileViewCreator.class);
	...
	public Object create() throws CoreException {
		...
		AreaDetectorProfileView view = new AreaDetectorProfileView(adController);
		try {
