...
public class TabFolderCompositeFactory implements CompositeFactory, InitializingBean {
	...
	public Composite createComposite(Composite parent, int style, IWorkbenchPartSite iWorkbenchPartSite) {
		final IIMageModeComposite comp = new IIMageModeComposite(parent, style, iWorkbenchPartSite, factories);
		comp.createControls();
		return comp;
	}
...
class IIMageModeComposite extends Composite {
	...
	public IIMageModeComposite(Composite parent, int style, IWorkbenchPartSite iWorkbenchPartSite,  TabCompositeFactory[] availableModes) {
		super(parent, style);
