...
public class JythonConsoleView extends ViewPart {
	public static final String ID = "uk.ac.gda.nano.views.JythonConsoleView";
	...
	void configureProperties() {
		...
		// Select thread behaviour between the two class name
		...
		//Choose to override the standard output into the JyConsole or not.
		System.setProperty("jyconsole.pref.print.std.stream","false");
		//Choose to override the standard output error into the JyConsole or not
		System.setProperty("jyconsole.pref.print.error.stream","false");
		//Loading script for initial configuration
		System.setProperty("jyconsole.pref.loading.script", getCommandRunner().locateScript("start_gda.py"));
	}
	...
	void setJythonContextForTesting(IJythonContext ctx) {
		jythonContextForTesting = ctx;
	}

	public void setCommandRunnerForTesting(ICommandRunner runner) {
