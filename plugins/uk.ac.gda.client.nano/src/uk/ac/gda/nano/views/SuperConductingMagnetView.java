...
public class SuperConductingMagnetView extends ViewPart {

	public static final String ID = "uk.ac.gda.nano.views.SuperConductingMagnetView";
	private static final Logger logger = LoggerFactory.getLogger(SuperConductingMagnetView.class);
	...
	public SuperConductingMagnetView() {
		super();
...
//		guiBase = new Composite(parent, SWT.SCROLL_LINE);
	...
	public void createMagnetGUI(Composite base) {
		...
		this.createComposite(guiBase, "magnetField");
		this.createComposite(guiBase, "magnetTemp");
		this.createComposite(guiBase, "magnetCool");

//		this.createMotionGUI(guiBase);
		}
