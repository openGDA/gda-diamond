...
package uk.ac.gda.nano.perspectives;
 ...
 *
 */
public class AdvancedScriptingPerspective implements IPerspectiveFactory {
	/**
	 * Do not change referenced in plugin.xml files but *also* beam line .ini files which do not refactor.
	 */
	public static final String ID = "uk.ac.gda.nano.AdvancedScriptingPerspective";
