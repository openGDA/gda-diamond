		...
		Display.getDefault().asyncExec(new Runnable() {
			...
			public void run() {
				try {
					...
					PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().showView("uk.ac.gda.beamline.i06.pco.live.stream.view.LiveStreamViewWithHistogram","pco_cam#EPICS_ARRAY",IWorkbenchPage.VIEW_CREATE);
