 ...
 *
 */
public class I06AdvancedScriptingPerspective implements IPerspectiveFactory {
	/**
	 * Do not change referenced in plugin.xml files but *also* beam line .ini files which do not refactor.
	 */
	public static final String ID = "uk.ac.gda.beamline.i06.AdvancedScriptingPerspective";
	...
	public void createInitialLayout(IPageLayout layout) {
        ...
        outputfolder.addView("uk.ac.gda.beamline.i06.terminalView");
