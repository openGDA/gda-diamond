...
package uk.ac.gda.beamline.i07.perspective;
 ...
 *
 */
public class I07AdvancedScriptingPerspective implements IPerspectiveFactory {
	/**
	 * Do not change referenced in plugin.xml files but *also* beam line .ini files which do not refactor.
	 */
	public static final String ID = "uk.ac.gda.beamline.i07.AdvancedScriptingPerspective";
