...
public class I07ScanPerspective implements IPerspectiveFactory {
	...
	private static final List<String> DETECTOR_PLOTS = List.of("uk.ac.gda.sixd.views.Pilatus2", "uk.ac.gda.sixd.views.Pilatus3",
			"uk.ac.gda.sixd.views.Excalibur", "uk.ac.gda.sixd.views.Eiger");
