 ...
 *
 */
public class SixdScriptingPerspective implements IPerspectiveFactory {
	/**
	 * Do not change referenced in plugin.xml files but *also* beam line .ini files which do not refactor.
	 */
	public static final String ID = "uk.ac.gda.client.sixd.ScriptingPerspective";
	...
	public void createInitialLayout(IPageLayout layout) {
        ...
        outputfolder.addView(JythonTerminalView.ID);
