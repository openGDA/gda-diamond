...
public class I07ScanPerspectiveExtensions extends ExtensionContributionFactory {

	@Override
	public void createContributionItems(IServiceLocator serviceLocator, IContributionRoot additions) {

		MenuManager search = new MenuManager("Dataset Options",
                "uk.ac.gda.client.sixd.I07ScanPerspective.dataset");
		...
		additions.addContributionItem(search, new Expression() {
			...
			public EvaluationResult evaluate(IEvaluationContext context) throws CoreException {
				...
				search.setVisible(I07ScanPerspective.ID.equals(variable));
				return EvaluationResult.valueOf(I07ScanPerspective.ID.equals(variable));
			}
		});
