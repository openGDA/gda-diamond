package uk.ac.diamond.daq.beamline.lab44;
		...
		Display.getDefault().asyncExec(new Runnable() {
			...
			public void run() {
				try {
					...
					PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().showView("uk.ac.diamond.daq.beamline.lab44.pcss.live.stream.view.LiveStreamViewWithHistogram","pcss_cam#EPICS_ARRAY",IWorkbenchPage.VIEW_ACTIVATE);
