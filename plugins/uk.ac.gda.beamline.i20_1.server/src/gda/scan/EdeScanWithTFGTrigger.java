...
//			}
	...
	private void addScalerFrameCountsToNexus() throws Exception {
		...
		try {
			...
			appendDataToNexus(file, EdeDataConstants.SCALER_FRAME_COUNTS, targetPath, DoubleDataset.createFromObject(topupScalerValueForSpectra));
			appendDataToNexus(file, "is_topup_measured_from_scaler", targetPath, DoubleDataset.createFromObject(topupValueUsesScalers));
			file.close();
		} catch (Exception e) {
	 ...
	 * @throws Exception
	 */
	private void appendDataToNexus(IHierarchicalDataFile file, String dataName, String fullPath, DoubleDataset data) throws Exception {
