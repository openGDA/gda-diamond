...
public class LookupTableEditorContributor extends MultiPageEditorActionBarContributor {
	...
	private void createActions() {
		...
		addRowAction.setImageDescriptor(I12BeamlineActivator.getDefault().getImageRegistry()
				.getDescriptor(ImageConstants.IMG_ADD));
		...
		deleteRowAction.setImageDescriptor(I12BeamlineActivator.getDefault().getImageRegistry()
