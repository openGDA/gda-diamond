...
public class I08ExperimentEditorManager extends ExperimentEditorManager implements IExperimentEditorManager {

	private static final Logger logger = LoggerFactory.getLogger(I08ExperimentEditorManager.class);
...
/*
		try {
			...
			if ((theScan instanceof MicroFocusScanParameters)){
				((I08SampleParameters)((ScanObject) ob).getSampleParameters()).getSampleStageParameters().setDisable(true);
			}
		} catch (Exception e) {
