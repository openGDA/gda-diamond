...
public class EdeScanTest extends EdeTestBase {
	...
	private void testNexusStructure(String  nexusFilename, int numberExpectedSpectra, int numberRepetitions) throws NexusException {
		...
		if (numberRepetitions > 1){
			assetLinearData(file,EdeLinearExperimentAsciiFileWriter.NXDATA_LN_I0_IT+"_averaged",numberExpectedSpectra, false);
			assetLinearData(file,EdeLinearExperimentAsciiFileWriter.NXDATA_LN_I0_IT_WITH_FINAL_I0+"_averaged",numberExpectedSpectra, false);
			assetLinearData(file,EdeLinearExperimentAsciiFileWriter.NXDATA_LN_I0_IT_WITH_AVERAGED_I0+"_averaged",numberExpectedSpectra, false);	
			numberExpectedSpectra *= numberRepetitions;
			assetLinearData(file,EdeLinearExperimentAsciiFileWriter.NXDATA_LN_I0_IT,numberExpectedSpectra, true);
			assetLinearData(file,EdeLinearExperimentAsciiFileWriter.NXDATA_LN_I0_IT_WITH_FINAL_I0,numberExpectedSpectra, true);
			assetLinearData(file,EdeLinearExperimentAsciiFileWriter.NXDATA_LN_I0_IT_WITH_AVERAGED_I0,numberExpectedSpectra, true);
		} else {
			assetLinearData(file,EdeLinearExperimentAsciiFileWriter.NXDATA_LN_I0_IT,numberExpectedSpectra, false);
			assetLinearData(file,EdeLinearExperimentAsciiFileWriter.NXDATA_LN_I0_IT_WITH_FINAL_I0,numberExpectedSpectra, false);
			assetLinearData(file,EdeLinearExperimentAsciiFileWriter.NXDATA_LN_I0_IT_WITH_AVERAGED_I0,numberExpectedSpectra, false);			
		}
		file.close();
	}
