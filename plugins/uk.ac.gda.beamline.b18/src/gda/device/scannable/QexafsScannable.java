...
public class QexafsScannable extends ScannableMotor implements ContinuouslyScannable, InitializationListener, IQexafsScannableState {
	...
	private static final String outputModePV = "BL18B-OP-DCM-01:PC:CTRL"; // 0 = OFF, 1 = ON, 2 = AUTO
	private static final String startPV = "BL18B-OP-DCM-01:PC:START"; // in degrees
	private static final String stopPV = "BL18B-OP-DCM-01:PC:STOP"; // in degrees
	private static final String stepPV = "BL18B-OP-DCM-01:PC:STEP"; // in degrees
	private static final String accelPV = "BL18B-OP-DCM-01:BRAGG:MPACCEL:RBV"; // in degrees/s/s
	private static final String xtalSwitchPV = "BL18B-OP-DCM-01:XTAL_SWITCH"; // will be a string such as "Si(111)"
	private static final String braggCurrentSpeedPV = "BL18B-OP-DCM-01:BRAGG:MPSPEED"; // the max and default speed of
	// Bragg motor
	private static final String braggMaxSpeedPV = "BL18B-OP-DCM-01:BRAGG:MPSPEED.DRVH"; // the max and default speed of
	// Bragg motor
	private static final String energySwitchPV = "BL18B-OP-DCM-01:ENERGY_SWITCH"; // combined energy motion flag
	
	private static final String stepIncDegPV = "BL18B-OP-DCM-01:PC:STEP"; // after start,stop,step set this is the step size in deg
	private static final String pulseWidthDegPV = "BL18B-OP-DCM-01:PC:PULSE"; // pulse width - treated here as read-only
	private static final String numPulsesPV = "BL18B-OP-DCM-01:PC:NPULSES"; // the number of pulses that will be sent out, after start,stop,step set
