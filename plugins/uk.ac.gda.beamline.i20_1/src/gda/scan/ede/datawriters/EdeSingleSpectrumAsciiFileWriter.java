...
public class EdeSingleSpectrumAsciiFileWriter extends EdeExperimentDataWriter {
	...
	private final EdeScanWithTFGTrigger itScan;
	private String asciiFilename;

	public EdeSingleSpectrumAsciiFileWriter(EnergyDispersiveExafsScan i0InitialScan, EdeScanWithTFGTrigger itScan, EnergyDispersiveExafsScan i0DarkScan,
