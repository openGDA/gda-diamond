...
public class XESRoomTempIterator implements SampleEnvironmentIterator {
	...
	public XESRoomTempIterator(I20SampleParameters i20Bean, Scannable sample_x, Scannable sample_y, Scannable sample_z,
			Scannable sample_rot, Scannable sample_fine_rot) {
	...
	public void next() throws DeviceException, InterruptedException {
		...
		boolean finerotEnabled = nextParameters.isFineRotEnabled();
		...
		Double finerotation = nextParameters.getSample_finerotation();
