...
public class XesOffsetsView extends HardwareDisplayComposite {
		...
		public XesOffsetsView(Composite parent, int style) {
		 ...
		 * @return
		 */
		private Map<String, Double> updateOffsetTextboxes() {
