...
/**
 * The summary handler for {@link AcquisitionTemplateType#TWO_DIMENSION_LINE} type
 *
 * @author Maurizio Nagni
 */
public class TwoDimensionLineSummaryHandler extends SummaryHandlerBase {

	public TwoDimensionLineSummaryHandler(AcquisitionSummary segmentUtils) {
		super(segmentUtils);
	}
