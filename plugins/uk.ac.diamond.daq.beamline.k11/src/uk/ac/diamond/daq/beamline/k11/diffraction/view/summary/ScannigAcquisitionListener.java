...
class ScannigAcquisitionListener implements ApplicationListener<ScanningAcquisitionEvent> {

	private final ShapeSummaryBase summary;
	private final Supplier<ScanningAcquisition> acquisitionSupplier;

	public ScannigAcquisitionListener(ShapeSummaryBase summary, Supplier<ScanningAcquisition> acquisitionSupplier) {
		super();
