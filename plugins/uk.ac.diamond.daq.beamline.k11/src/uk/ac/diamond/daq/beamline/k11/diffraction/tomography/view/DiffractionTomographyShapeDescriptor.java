...
public enum DiffractionTomographyShapeDescriptor implements ShapeDescriptor {

	POINT(TrajectoryShape.TWO_DIMENSION_POINT, ClientImages.POINT, new PointMappingRegion(), CORCentredPointEditor::new),
	SNAPPED_LINE(TrajectoryShape.TWO_DIMENSION_LINE, ClientImages.LINE, new SnappedLineMappingRegion(), CORCentredLineEditor::new),
	RECTANGLE(TrajectoryShape.TWO_DIMENSION_GRID, ClientImages.CENTERED_RECTAGLE, new CentredRectangleMappingRegion(), CORCentredRectangleEditor::new);
	...
	DiffractionTomographyShapeDescriptor(TrajectoryShape shape, ClientImages icon, IMappingScanRegionShape mappingRegion, Supplier<ScanpathEditor> editor) {
		this.shape = shape;
		this.icon = icon;
