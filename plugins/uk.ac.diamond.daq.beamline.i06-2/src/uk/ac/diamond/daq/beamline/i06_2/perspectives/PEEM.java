package uk.ac.diamond.daq.beamline.i06_2.perspectives;
...
public class PEEM implements IPerspectiveFactory {
	...
	static final String ID = "uk.ac.diamond.daq.beamline.i06-2.perspective.Peem";
	...
	private void defineLayout(IPageLayout layout) {
		...
		IFolderLayout topRightFolder=layout.createFolder(PLOT_2D_FOLDER, IPageLayout.RIGHT, (float)0.48, IPageLayout.ID_EDITOR_AREA); //$NON-NLS-1$
